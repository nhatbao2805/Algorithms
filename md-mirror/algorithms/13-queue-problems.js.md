# Ôn Tập Mã Nguồn — `algorithms/13-queue-problems.js`
...
- **Cơ bản**
  ...
  - BÀI 5: Implement queue chỉ dùng 2 stack (push vào stack1, pop từ stack2 khi rỗng thì đổ stack1 sang).
  - BÀI 6: BFS đơn giản: duyệt đồ thị theo tầng bằng queue (in thứ tự từ đỉnh start).
- **Trung bình**
  - BÀI 7: Design circular queue: front, rear, size, isFull, isEmpty.
  - BÀI 8: Sliding window maximum dùng deque (monotonic): giữ chỉ số trong deque, phần tử tương ứng giảm dần.
  - BÀI 9: Number of islands (BFS với queue): đếm thành phần liên thông trên lưới 0/1.
- **Nâng cao**
  - BÀI 10: Implement queue với getMin() trong O(1) (dùng 2 stack hoặc deque phụ).
  - BÀI 11: Level order traversal cây nhị phân (in từng tầng một dòng), dùng queue.
  - BÀI 12: Rate limiter: cho phép tối đa n request trong 1 giây, dùng queue lưu timestamp.
