# Ôn Tập Mã Nguồn — `algorithms/21-greedy-problems.js`
...
- **Cơ bản**
  ...
  - BÀI 5: Assign cookies: trẻ có greed[], bánh có size[], mỗi trẻ tối đa 1 bánh. Số trẻ thỏa mãn tối đa.
  - BÀI 6: Lemonade change: khách trả 5/10/20, có đủ tiền thối không (greedy ưu tiên trả 10 trước).
- **Trung bình**
  - BÀI 7: Jump Game II: số bước nhảy ít nhất để đến cuối.
  - BÀI 8: Partition labels: chia string thành các đoạn sao cho mỗi ký tự chỉ xuất hiện trong 1 đoạn, số đoạn ít nhất.
  - BÀI 9: Minimum number of arrows to burst balloons: intervals, 1 mũi tên xuyên nhiều balloon overlap. Tìm số mũi tên ít nhất.
- **Nâng cao**
  - BÀI 10: Candy: mỗi trẻ có rating, mỗi trẻ ít nhất 1 kẹo, 2 trẻ cạnh nhau rating cao hơn thì nhiều kẹo hơn. Tổng kẹo ít nhất.
  - BÀI 11: Remove K digits: từ số (string) bỏ k chữ số để số còn lại nhỏ nhất (monotonic stack / greedy).
  - BÀI 12: Merge intervals: gộp các đoạn giao nhau, sort theo start rồi greedy merge.
