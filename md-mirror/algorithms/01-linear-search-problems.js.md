# Ôn Tập Mã Nguồn — `algorithms/01-linear-search-problems.js`
...
- **Cơ bản**
  ...
  - BÀI 5: Kiểm tra target có tồn tại trong mảng hay không (trả true/false).
  - BÀI 6: Tìm giá trị nhỏ nhất / lớn nhất trong mảng (1 lần duyệt).
- **Trung bình**
  - BÀI 7: Tìm phần tử đầu tiên lặp lại (xuất hiện ≥ 2 lần).
  - BÀI 8: Tìm 2 phần tử có tổng = target (2 vòng for → sau đó tối ưu bằng map).
  - BÀI 9: Tìm subarray liên tiếp có tổng lớn nhất (Kadane hoặc brute force).
- **Nâng cao**
  - BÀI 10: Tìm phần tử thiếu trong mảng [1..n] (chỉ thiếu 1 số), O(n).
  - BÀI 11: Cho mảng có 1 số xuất hiện 1 lần, còn lại xuất hiện 2 lần. Tìm số đó (dùng XOR).
  - BÀI 12: Tìm median của 2 mảng đã sort (không merge, tìm trực tiếp).
